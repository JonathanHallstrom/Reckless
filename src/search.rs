...
fn eval_correction(td: &ThreadData, ply: isize) -> i32 {
    ...
    (corrhist.pawn.get(stm, td.board.pawn_key() ^ td.board.halfmove_hash())
        + corrhist.minor.get(stm, td.board.minor_key() ^ td.board.halfmove_hash())
        + corrhist.non_pawn[Color::White].get(stm, td.board.non_pawn_key(Color::White) ^ td.board.halfmove_hash())
        + corrhist.non_pawn[Color::Black].get(stm, td.board.non_pawn_key(Color::Black) ^ td.board.halfmove_hash())
...
fn update_correction_histories(td: &mut ThreadData, depth: i32, diff: i32, ply: isize) {
    ...
    corrhist.pawn.update(stm, td.board.pawn_key() ^ td.board.halfmove_hash(), bonus);
    corrhist.minor.update(stm, td.board.minor_key() ^ td.board.halfmove_hash(), bonus);

    corrhist.non_pawn[Color::White].update(stm, td.board.non_pawn_key(Color::White) ^ td.board.halfmove_hash(), bonus);
    corrhist.non_pawn[Color::Black].update(stm, td.board.non_pawn_key(Color::Black) ^ td.board.halfmove_hash(), bonus);
